    ...
    <div class="inventory-container">
        <div class="header-actions">
            ...
            <div class="header-buttons">
                <a href="../logics/add.php" class="btn-add">+ Add New Item</a>
                <a href="../logics/delete.php" class="btn-delete">Delete Item</a>
            </div>
        </div>
        ...
        <tbody>
            ...
            try {
                ...
                echo "<tr><td colspan='7' class='text-center text-danger'>Error loading inventory: " . htmlspecialchars($e->getMessage()) . "</td></tr>";
            }
            ?>
        </tbody>
            </table>
